/**
 * Decide quali errori JavaScript contano: scarta quelli di terze parti e quelli
 * dichiarati noti in targets.json. Pretendere zero errori non funzionerebbe —
 * dev.bsg.it ne produce già uno a riposo. Funzioni pure, senza browser.
 */
