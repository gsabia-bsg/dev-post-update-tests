/**
 * Collauda i controlli, non il sito: ogni caso usa una pagina costruita al volo
 * con `setContent()` — un div da 5000px, un'immagine corrotta, un titolo vuoto.
 * Serve a dimostrare che i controlli sanno dire NO, cosa che un test su una
 * pagina sana non prova mai.
 */
